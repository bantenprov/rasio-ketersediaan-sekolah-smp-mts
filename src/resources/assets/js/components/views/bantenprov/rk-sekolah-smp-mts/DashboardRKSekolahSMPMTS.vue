    ...
    <div class="row">
      <div class="col-lg-6 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #2196F3;">
          <div class="card-body">
            <rk-sekolah-smp-mts-bar-03></rk-sekolah-smp-mts-bar-03>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
      <div class="col-lg-6 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #4CAF50;">
          <div class="card-body">
            <rk-sekolah-smp-mts-pie-03></rk-sekolah-smp-mts-pie-03>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
    </div><!-- /.row -->
    ...
    <div class="row">
      <div class="col-lg-8 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #009688;">
          ...
          <div class="card-body">
            <rk-sekolah-smp-mts-bar-01></rk-sekolah-smp-mts-bar-01>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
      <div class="col-lg-4 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #FF9800;">
          ...
          <div class="card-body">
            <rk-sekolah-smp-mts-pie-01></rk-sekolah-smp-mts-pie-01>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
    </div><!-- /.row -->
    ...
    <div class="row">
      <div class="col-lg-6 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #F44336;">
          ...
          <div class="card-body">
            <rk-sekolah-smp-mts-pie-02></rk-sekolah-smp-mts-pie-02>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /.col -->
      <div class="col-lg-6 mb-3">
        <div class="card text-white bg-dark h-100">
          ...
          <div class="card-body">
            <rk-sekolah-smp-mts-bar-02></rk-sekolah-smp-mts-bar-02>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
    </div><!-- /.row -->
