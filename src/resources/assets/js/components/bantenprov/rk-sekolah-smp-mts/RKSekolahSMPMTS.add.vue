    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/rk-sekolah-smp-mts/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/rk-sekolah-smp-mts/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/rk-sekolah-smp-mts/create'
                  }
                },
                window.location.href = '#/admin/rk-sekolah-smp-mts/create')
        ...
        back() {
            window.location = '#/admin/rk-sekolah-smp-mts';
        }
    },
    mounted: function() {
        axios.get("/rk-sekolah-smp-mts/create").then(response => {
